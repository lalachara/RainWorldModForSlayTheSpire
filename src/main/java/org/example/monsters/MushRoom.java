...
public class MushRoom extends CustomMonster {
    ...
    public int Sleep = 2;
    public boolean Awake = false,isSleep = true;
    // 怪物的图片，请自行添加
    ...
    public MushRoom(float x, float y) {
        ...
        // 图片
        // 怪物位置（x,y）
        super(NAME, ID, 140, 0.0F, 0.0F, 250.0F, 450.0F, IMG, x, y);
    ...
    public void usePreBattleAction() {
        ...
        addToBot(new ApplyPowerAction(this,this,new ProliferationBuff(this,AbstractDungeon.ascensionLevel >= 9?15: 10)));
        ...
        switch (this.nextMove) {
            ...
            case 5://塞眩晕
                addToBot(new com.megacrit.cardcrawl.actions.common.MakeTempCardInDiscardAction(
                        new Dazed(), (AbstractDungeon.ascensionLevel >= 9)?4:3
                ));
                break;
        }
