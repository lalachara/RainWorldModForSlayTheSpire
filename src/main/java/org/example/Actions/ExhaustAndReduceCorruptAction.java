...
public class ExhaustAndReduceCorruptAction extends AbstractGameAction {
    ...
    public ExhaustAndReduceCorruptAction(int amount, boolean isRandom, boolean anyNumber, boolean canPickZero) {
...
//            }
        ...
        if (!AbstractDungeon.handCardSelectScreen.wereCardsRetrieved) {
            ...
            while(var4.hasNext()) {
                ...
                this.p.hand.moveToExhaustPile(c);
                if(c.cardID== RedCat_Corrupt.ID||c.cardID== RedCat_OriginalCorrupt.ID&&AbstractDungeon.player instanceof RedCat)
