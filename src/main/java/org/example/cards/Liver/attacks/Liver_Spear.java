...
public class Liver_Spear extends CustomCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:Spear";
    //卡牌插画路径
...
//        AbstractPower strength = AbstractDungeon.player.getPower(SpearMasterNoteBuff.POWER_ID);
//        if (strength != null) {
//            int amount = strength.amount;
