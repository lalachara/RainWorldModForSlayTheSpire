...
import org.example.powers.KittyBuff;

import static org.example.Character.SlugCat.Enums.Liver_Color;

public class Liver_Kitty extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:Kitty";
    //卡牌插画路径
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new KittyBuff(p,1),1));
}
