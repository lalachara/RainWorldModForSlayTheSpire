...
import org.example.powers.AcmeDefendBuff;

import static org.example.Character.SlugCat.Enums.Liver_Color;

public class Liver_AcmeDefend extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:AcmeDefend";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_SuperDefend.png";
    //固定，不要修改
    ...
    public Liver_AcmeDefend() {
    super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
}

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p,p,new AcmeDefendBuff(p,1),1));
}
