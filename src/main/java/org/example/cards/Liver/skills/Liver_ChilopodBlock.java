...
public class Liver_ChilopodBlock extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:ChilopodBlock";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_Wugong.png";
    //固定，不要修改
    ...
    public Liver_ChilopodBlock() {
    super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
    this.baseBlock = this.block = 8; // 设置初始值
        this.magicNumber = this.baseMagicNumber = 1;
}

    @Override
    public void use(AbstractPlayer p, AbstractMonster m) {
        //CardCrawlGame.sound.play("Liver:Wugong");
