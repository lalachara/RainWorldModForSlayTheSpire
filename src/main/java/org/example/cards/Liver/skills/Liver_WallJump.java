...
public class Liver_WallJump extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:WallJump";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_WallJump.png";
    //固定，不要修改
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new GainBlockAction(p, p, this.block));
        addToBot(new ApplyPowerAction(p,p,new NimbleBuff(p, this.magicNumber), this.magicNumber));
