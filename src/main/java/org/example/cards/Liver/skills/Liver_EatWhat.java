...
public class Liver_EatWhat extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:EatWhat";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_EatWhat.png";
    //固定，不要修改
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (!p.drawPile.isEmpty()) {
            ...
            addToBot(new ExhaustSpecificCardAction(topCard,p.drawPile,true));
            if(p instanceof SlugCat){
                ((SlugCat) p).addFood(magicNumber);
