...
public class Liver_BigJump extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:BigJump";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_Bigjump.png";
    //固定，不要修改
    ...
    public Liver_BigJump() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        this.baseBlock = 8;
        this.cardsToPreview = new Liver_Fruit(); // 设置预览卡牌
