...
import org.example.powers.OldSixBuff;

import static org.example.Character.SlugCat.Enums.Liver_Color;

public class Liver_LiveWill extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:LiveWill";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_LiveWill.png";
    //固定，不要修改
    ...
    addToBot(new ApplyPowerAction(p,p,new OldSixBuff(p, magicNumber), magicNumber));
