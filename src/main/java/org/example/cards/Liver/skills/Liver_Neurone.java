...
import org.example.Actions.ExhaustPermanentlyAction;
import org.example.Character.*;

import static org.example.Character.SlugCat.Enums.Liver_Color;

public class Liver_Neurone extends CustomCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "Liver:Neurone";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_Neurone.png";
    //固定，不要修改
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(p instanceof SlugCat){
            ...
            player.forceIncreaseMaxHp(magicNumber,true);
