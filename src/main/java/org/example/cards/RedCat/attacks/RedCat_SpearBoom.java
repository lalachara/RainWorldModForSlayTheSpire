...
public class RedCat_SpearBoom extends RedCatCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:SpearBoom";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_SpearBoom.png";
    //固定，不要修改
    ...
    public RedCat_SpearBoom() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, RARITY, TARGET);
        this.damage  = this.baseDamage = 8;
        this.tags.add(Spear_TAG);
        this.tags.add(Treasure_TAG);
        this.exhaust = true;
        this.cardsToPreview = new RedCat_Spear(); // 设置预览卡牌
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        CardCrawlGame.sound.play("Liver:SpearBomb");
        ...
        AbstractCard c = new RedCat_Spear();
        if(upgraded){

            c.upgrade();
        }
        addToBot(new CheckPearlAction());
        addToBot(new com.megacrit.cardcrawl.actions.common.MakeTempCardInDiscardAction(c, 1));
    }
