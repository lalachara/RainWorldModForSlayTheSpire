...
public class RedCat_Strike extends RedCatCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:Strike";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_Strike.png";
    //固定，不要修改
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Liver:Strike");
    ...
    public RedCat_Strike() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, RARITY, TARGET);
        DESCRIPTIONID = "Liver:Strike";
        this.damage = this.baseDamage = 6;
        this.tags.add(CardTags.STARTER_STRIKE);
        this.tags.add(CatStrike_Tag);
...
//    @Override
//    public void Corrupt() {
//        AbstractCard CorruptedCard = new RedCat_CorruptStrike();
//        if(upgraded)
...
//    }
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new RedCat_Strike();
    }
