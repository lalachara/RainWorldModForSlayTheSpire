...
public class RedCat_KeenStrike extends RedCatCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:KeenStrike";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/RedCat/KeenStrike.png";
    //固定，不要修改
