...
public class RedCat_SpearDouble extends RedCatCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:SpearDouble";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_SpearDouble.png";
    //固定，不要修改
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Liver:SpearDouble");
    ...
    public RedCat_SpearDouble() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, RARITY, TARGET);
        this.damage  = this.baseDamage = 5;
        this.magicNumber = this.baseMagicNumber = 2;
        this.tags.add(Spear_TAG);
        DESCRIPTIONID = "Liver:SpearDouble";
