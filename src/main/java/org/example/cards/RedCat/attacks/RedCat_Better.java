...
public class RedCat_Better extends RedCatCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:Better";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/RedCat/Start.png";
    //固定，不要修改
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
                addToBot(new BetterAction( m, new DamageInfo(p, this.damage, this.damageTypeForTurn)));
    }
