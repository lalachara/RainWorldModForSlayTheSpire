...
public class RedCat_CatLost extends RedCatCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:CatLost";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/RedCat/Lost.png";
    //固定，不要修改
    ...
    public void atTurnStart() {
        baseMagicNumber = AbstractDungeon.cardRng.random(1,upgraded?3:2);
        baseDamage = AbstractDungeon.cardRng.random(2,upgraded?10:9);
        super.atTurnStart();
    }
