...
import org.example.powers.CripplePower;


import static org.example.Character.SlugCat.Enums.Liver_Color;
import static org.example.Character.SlugCat.Enums.Spear_TAG;

public class RedCat_Cripple extends RedCatCard {
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:Cripple";
    //卡牌插画路径
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m,p,new CripplePower(m, 1), 1));
    }
