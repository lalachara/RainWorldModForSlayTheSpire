...
public class RedCat_Twist extends RedCatCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:Twist";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/RedCat/Die.png";
    //固定，不要修改
...
//        this.cardsToPreview = new RedCat_Corrupt();
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
      addToBot(new ApplyPowerAction(p,p,new TwistPower(p,magicNumber),magicNumber));
    }
