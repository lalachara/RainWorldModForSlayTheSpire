...
public class RedCat_Expand extends RedCatCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:Expand";
    //卡牌插画路径
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p,
                new BackToHandPower(p, this.magicNumber), this.magicNumber));
    }
