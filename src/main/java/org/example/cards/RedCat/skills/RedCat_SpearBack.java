...
public class RedCat_SpearBack extends RedCatCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:SpearBack";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/RedCat/BackSpear.png";
    //固定，不要修改
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractCard c:p.masterDeck.group){
            if (c.hasTag(SlugCat.Enums.Spear_TAG)){
                amount++;
            }
        }
        addToBot(new GainBlockAction(p, p, this.block + this.magicNumber * amount));
    }
