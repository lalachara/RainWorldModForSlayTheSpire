...
import org.example.powers.RedCat.InjectPower;

import static org.example.Character.SlugCat.Enums.CantCorrupt_Tag;

public class RedCat_Inject extends RedCatCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:Inject";
    //卡牌插画路径
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot( new ApplyPowerAction(p,p,new InjectPower(p,1),1) );
    }
