...
public class RedCat_MDBaole extends RedCatCard
{
    //卡牌ID，命名规则: mod名:卡牌名
    public static final String ID = "RedCat:MDBaole";
    //卡牌插画路径
    public static final String IMG_PATH = "images/CharacterImg/Cards/Liver_MDbaole.png";
    //固定，不要修改
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("Liver:MDBaole");
    ...
    public RedCat_MDBaole() {
    super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, RARITY, TARGET);
        DESCRIPTIONID = "Liver:MDBaole";
