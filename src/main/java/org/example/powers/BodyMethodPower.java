...
public class BodyMethodPower extends AbstractPower {
    public static final String POWER_ID = "RedCat:BodyMethodPower";
    ...
    public BodyMethodPower(AbstractCreature owner, int amount) {
        this.ID = POWER_ID;
        this.name = NAME;
        this.owner = owner;
        this.amount = amount;
