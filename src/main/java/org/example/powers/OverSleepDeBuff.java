...
public class OverSleepDeBuff extends AbstractPower {
    public static final String POWER_ID = "Liver:OverSleepDeBuff";
    ...
    public OverSleepDeBuff(AbstractCreature owner, int amount) {
        this.ID = POWER_ID;
        this.name = NAME;
        this.owner = owner;
        this.amount = amount;
