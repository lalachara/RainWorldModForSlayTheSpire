...
public class ToothBuff extends AbstractPower {
    public static final String POWER_ID = "Liver:Tooth";
    ...
    public ToothBuff(AbstractCreature owner, int amount) {
        this.ID = POWER_ID;
        this.name = NAME;
        this.owner = owner;
        this.amount = amount;
