...
public class Embolden extends AbstractPower {
    public static final String POWER_ID = "Liver:Embolden";
    ...
    public Embolden(AbstractCreature owner, int amount) {
        this.ID = POWER_ID;
        this.name = NAME;
        this.owner = owner;
        this.amount = amount;
    ...
    public void onApplyPower(AbstractPower power, AbstractCreature target, AbstractCreature source) {
        ...
        if(target!=this.owner&&source==this.owner&&power.type== PowerType.DEBUFF)
        {
