...
public class StudyPower extends AbstractPower {
    public static final String POWER_ID = "RedCat:StudySpear";
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    private static final String IMG_128 = "images/CharacterImg/Powers/RedCat/StudySpear_128.png";
    private static final String IMG_48 = "images/CharacterImg/Powers/RedCat/StudySpear_48.png";
